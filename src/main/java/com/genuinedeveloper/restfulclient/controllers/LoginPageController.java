...
public class LoginPageController {
	...
	public void initialize() {
		...
		// Automatically supplied credentials for system testing
		id_textfield.setText("4");
		username_textfield.setText("testusername");
		password_textfield.setText("testpassword");
		...
		submit_button.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				boolean result = restApiObject.login(Integer.parseInt(id_textfield.getText()),
						username_textfield.getText(), password_textfield.getText());
